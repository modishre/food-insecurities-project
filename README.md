...
Link to GitHub Pages: `https://bradyduncan.github.io/food-insecurities-USA/`
...
1. Create a GitHub Page for your repo and add the link to your GitHub Page above where you see `[insert your hyperlink here]` (if you put the link inside of the `[]` and the `()` you will get a clickable hyperlink). 
